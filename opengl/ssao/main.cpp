...
int main(int argc, char **argv)
{
	...
	/*
	Shader shaderLightingPass("quard.vs", "ssao_lighting.fs");
	Shader shaderSSAO("quard.vs", "ssao.fs");
	Shader shaderSSAOBlur("quard.vs", "ssao_blur.fs");
	*/
...
#define lerp(a, b, c)	(a) + c * ((b) - (a))
	...
	// ----------------------
	// 16 points random locate on the TB plane
 ...
 // --------------------
	...
	*/
	...
	Shader DrawIntermediate("quard.vs", "quard.fs");
